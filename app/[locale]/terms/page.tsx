...
export async function generateMetadata({
  ...
  return {
    title: "Terms of Use · StreamFinder",
    description:
      "Terms and conditions for using StreamFinder. A free, legal streaming search engine — not a piracy site.",
    alternates: {
      canonical,
      languages: {
        en: "/terms",
    ...
    openGraph: {
      ...
      title: "Terms of Use · StreamFinder",
      description: "Terms and conditions for using StreamFinder.",
    },
  }
}
...
export default async function TermsPage({
  ...
  return (
    <LegalLayout title="Terms of Use" lastUpdated="May 18, 2025" locale={locale}>
      <Section title="1. About StreamFinder">
        <p>
          StreamFinder is a <strong>streaming search engine</strong>. We index publicly available
        ...
        <p>
          <strong>StreamFinder does not host, store, distribute, or link to pirated content.</strong>{" "}
      ...
      <Section title="2. Acceptance of Terms">
        <p>
          By accessing or using StreamFinder at <a href={SITE_URL}>{SITE_URL}</a>, you agree to
          be bound by these Terms of Use. If you do not agree, please do not use the service.
        </p>
      </Section>

      <Section title="3. Permitted Use">
        <p>You may use StreamFinder to:</p>
        <ul>
        ...
        <p>You may not use StreamFinder to:</p>
        <ul>
      ...
      <Section title="4. Intellectual Property">
        <p>
          All movie and TV show metadata, posters, and descriptions displayed on StreamFinder are
        ...
        <p>
          StreamFinder&apos;s own code, design, and original content are protected by copyright. You
      ...
      <Section title="5. Affiliate Links and Advertising">
        <p>
          StreamFinder participates in affiliate programmes including{" "}
      ...
      <Section title="6. Disclaimer of Warranties">
        <p>
          StreamFinder is provided &quot;as is&quot; without warranty of any kind. Streaming
      ...
      <Section title="7. Limitation of Liability">
        <p>
          To the fullest extent permitted by law, StreamFinder and its operators shall not be
      ...
      <Section title="8. Third-Party Links">
        <p>
          StreamFinder contains links to third-party streaming platforms. These are provided for
      ...
      <Section title="9. Changes to These Terms">
        <p>
          ...
          upon posting. Your continued use of StreamFinder after any changes constitutes your
